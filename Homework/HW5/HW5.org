...
D. Identify the orbitals. What are their occupancies and energies? Which orbitals are kept in the core? (Hint: ~calc.get_eigenvalues(spin=0)~, ~calc.get_occupation_numbers()~)
