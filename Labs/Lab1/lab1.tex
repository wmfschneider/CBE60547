...
\label{sec:org7e82643}
At the Linux command line you will be working interactively with a \texttt{=shell=}. The shell
provides a lot of built-in features, is programmable, and gives access to There are many different shells, but the most
popular today is \href{https://www.gnu.org/software/bash/manual/}{bash}.  Here is a list of common linux commands, along with an example of
their output. Try typing these in your xterm window.
...
\label{sec:org793e1be}

\subsubsection{The basics}
\label{sec:orge5ac040}
...
\label{sec:orga01aece}

\begin{enumerate}
\item Using Quad
\label{sec:org90f4da8}
\begin{minted}[frame=lines,fontsize=\scriptsize,linenos]{python}
